...
class DirnameTest < Minitest::Test
  def test_it_compares_against_file_dirname
    result_pair = ->str{
      [
        File.dirname(str),
        FasterPath.dirname(str)
      ]
    }
    assert_equal( *result_pair.("aa/a//a")                 )
    assert_equal( *result_pair.("/a//a")                   )
    assert_equal( *result_pair.(".a/a//a")                 )
    assert_equal( *result_pair.("aa/../a")                 )
    assert_equal( *result_pair.(".")                       )
    assert_equal( *result_pair.("")                        )
    assert_equal( *result_pair.("/")                       )
    assert_equal( *result_pair.("/initrd.img.old")         )
    assert_equal( *result_pair.("//asdf//")                )
    assert_equal( *result_pair.("./.a/.b.txt")             )
    assert_equal( *result_pair.("/.a/.b.txt")              )
  end
